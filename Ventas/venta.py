...
while True:
    opMenu = int(
        input("Presiona 1 si eres cliente o 2 si eres vendedor o 9 si quieres salir: "))
    if opMenu == 9:
        break
    elif opMenu == 1:
        opCliente = int(input(
            "eres cliente nuevo presiona 1 o si eres cliente antogui digit tu codigo  o 9 si quieres salir: "))
        if opCliente == 9:
            break
        elif opCliente == 1:
            ...
            if clienteEncontado:
                opEncontrado = int(
                    input("Deseas Comprar un Helado 1, deseas salir 9"))
                if opEncontrado == 9:
                    break
                else:
        ...
        opMenuVendedor = int(
            input("Comprar helado 1, vender helado 2, ver inventario 3, salir 9: "))
        if(opMenuVendedor == 9):
            break
